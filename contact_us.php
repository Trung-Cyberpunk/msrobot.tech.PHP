                ...
                <div class="container_ctu">
                    <div class="box_information">
                        ...
                        <div class="information_ct" style="width:48%">
                            <label for="email_information">Your email: <strong
                                    style="color: rgba(210, 0, 13, 1);">*</strong></label>
                            <input type="text" id="email_information" placeholder="Enter">
                        </div>

                        <div class="information_ct" style="width:48%">
                            <label for="name_information">Email: <strong
                                    style="color: rgba(210, 0, 13, 1);">*</strong></label>
                            <input type="text" id="name_information" placeholder="Enter">
                        </div>

                        <div class="information_ct" style="width:100%">
                            <label for="subject_information">Subject: <strong
                                    style="color: rgba(210, 0, 13, 1);">*</strong></label>
                        ...
                        <div class="information_ct" style="width:100%">
                            ...
                            <textarea name="message_information" id="" cols="30" rows="10"
                                placeholder="I would like to know more about MS Robot/Selenium."
                                style="resize:none; padding: 1rem;font-size: 1.1rem; opacity: 0.7; "></textarea>
                        </div>
                    </div>
                    <span>This will send your message to us for more informations. We will answer your questions by
