            ...
            <div class="container_askQS">
                <div class="ask_box">
                    ...
                    <div class="ask_box-item">
                        ...
                        <?php
                        if(isset($_COOKIE['user'])){
                            echo '<a href="forum_qs_ask.php"><button class="btn_ask">Review your question</button></a>';
                        }else{
                            echo '<a href="forum_ask_login.php"><button class="btn_ask">Review your question</button></a>';
                        }
                        ?>
                    </div>
                </div>
                    ...
                    <div class="ask_box-content">
                        ...
                        <div class="draft_qs">
                            ...
                            <div class="box_dr">
                                ...
                                <ul class="a">
                                    <li style="list-style-type: disc; list-style-position: inside;">Include details
                                        about
                                        your goal</li>
                                    <li style="list-style-type: disc; list-style-position: inside;">Describe expected
                                        and
                                        actual results</li>
                        ...
                        <div class="draft_qs">
                            ...
                            <div class="box_dr">
                                ...
                                <ul class="a">
                                    <li>Show what you’ve tried and tell us what you found (on this site or elsewhere)
                                        and
