            ...
            <div class="automation_actions">
                ...
                <div class="item_btn-aciton">
                    ...
                    <div class="container_action">
                        <div class="notify">
                            <div class="title-notify">Re-Order Elements provided. For Ex : Move Car to Motobike place
                            </div>
                    ...
                    <div class="container_action">
                        <div class="notify">
                            <div class="title-notify">Specify using the “accept” option which element (or group of
                                elements) is accepted by the target droppable.</div>
                            <button id="x_action" class="bx bx-x"></button>
                        </div>
                        <div class="accept">
