    ...
    <body>
        ...
        <div class="backgr">
            ...
            <div class="question_container-item">
                <div class="question_content_2">

                    <div class="qs_item-container">
                        <div class="qs_item-box_2">
                    ...
                    <div class="qs_content_2">
                        <div class="qs_boxContent">
                            <div class="qs_votes_2">
                                <a href=""><img src="/msrobot.tech.PHP/assets/img/forum/up.png" alt=""
                                        id="votes_up"></a>
                                <span>18</span>
                                <a href=""><img src="/msrobot.tech.PHP/assets/img/forum/down.png" alt=""
                                        id="votes_down"></a>
                                <h4>Votes</h4>
                            </div>
                            <div class="qs_content-box">
                                <p>
                                    ...
                                    primarily entrepreneurs and ‘startup people’ who are driven to build new businesses
                                    with
                                    code, although the proposed approach is also transferable to other domains and
                                    audiences.
                                    <br>
                                    <br>
                                    The single most important factor for succeeding in learning programming has been
                                    found
                                    to be of human nature: learner motivation and persistence. While most beginners and
                                    the
                                    ...
                                    learning process itself. Learning programming is thus divided into three main
                                    steps:<br>
                                    First, I highlight the importance of setting a strong learning goal for motivation,
                                    and
                                    provide a big-picture overview of what ‘learning programming’ encompasses to
                                    structure
                                    the approach.<br>
                                    ...
                                    resources.<br>
                                    Lastly, the paper concludes with tips for optimizing the learning process by
                                    introducing
                                    effective learning techniques, highlighting the importance of programming practice,
                                    and
                                    collecting additional advice from programmers and self-learners.<br>
                                    <br>
                                </p>
                            </div>
                        </div>

                        <div class="box_qs_footer">
                            <div class="search_box">
                                <button class="search_btn">selenium</button>
                                <button class="search_btn">automation test</button>
                            </div>
                            <div class="share_qs">
                                <h4>Share :</h4>
                                <img src="/msrobot.tech.PHP/assets/img/blog_img/Facebook.png" alt="">
                                <img src="/msrobot.tech.PHP/assets/img/blog_img/Twitter.png" alt="">
                            </div>
                        </div>
                        ...
                        <div class="ansewers">
                            ...
                            <div class="btn_selection">
                                ...
                                <button id="selection_views">Oldest </button>
                                <button id="selection_asked-by">Votes</button>
                            </div>
                        </div>
                        <hr style="
                    border-style: solid;
                    ...
                    ">
                        ...
                        <br>
                        <div class="information_2">
                            <span>Asked in: <strong style="color:rgba(7, 68, 242, 1);">Tony Stark</strong></span>
                            <span>Answered 29 mins ago</span>
                        </div>
                        ...
                        <div class="qs_boxContent">
                            ...
                            <div class="qs_content-box">
                                <p>
                                    ...
                                    guess there could be a lot of stuff typed in here, but I am too lazy to test that
                                    out.
                                    <br>
                                    <br>
                                    To start your self-learning, you need to learn for free on the internet. Its
                    ...
                    opacity: 0.5;
                    ">
                        <div class="qs_boxContent_2">
                            <p>
                                This is just a test to see what options are available when submitting a question.
                                I guess there could be a lot of stuff typed in here, but I am too lazy to test that out.
                                <strong style="color: rgba(7, 68, 242, 1);">Peter Monica</strong> <span
                                    style="color: rgba(162, 162, 162, 1);">Apr 16 at 6:57</span>
                            </p>
                            <hr style="
                    border-style: solid;
                    border-width: 0.1px;
                    ...
                    ">
                            <p>
                                ...
                                Its recommendations are based on a review of the existing academic literature which is
                                complemented by the analysis of numerous contributions
                                by software developers, self-learners, and teachers of programming. <br>
                                <strong style="color: rgba(7, 68, 242, 1);">Peter Monica</strong> <span
                                    style="color: rgba(162, 162, 162, 1);">Apr 16 at 6:57</span>
                            </p>
                            <hr style="
                    ...
                    ">
                        ...
                        <div class="box_qs_footer">
                            <div class="search_box">
                                <a href="#"><span>Add a comment</span></a>
                            </div>
                            <div class="share_qs">
                                <h4>Share :</h4>
                                <img src="/msrobot.tech.PHP/assets/img/blog_img/Facebook.png" alt="">
                    ...
                    ">
                        ...
                        <div class="information_2">
                            <span>Answered by: <strong style="color:rgba(7, 68, 242, 1);">John Pablo</strong></span>
                            <span>Answered 29 mins ago</span>
                        </div>
                        ...
                        <div class="qs_boxContent">
                            ...
                            <div class="qs_content-box">
                                <p>
                                    ...
                                    with
                                    code,
                                    although the proposed approach is also transferable to other domains and audiences.
                                </p>
                            </div>
                        </div>
                        <div class="box_qs_footer">
                    ...
                    ">
                        ...
                        <div class="post_anw">
                            <h2>Your Answer</h2>
                            <div id="summernote"><img src="/msrobot.tech.PHP/assets/img/forum/Search.png" alt=""
                                    style="width:100%"></div>
                            <button class="btn_post">Post your answer</button>
                            <p>Not the answer you're looking for? Browse other questions tagged <button
                                    class="search_btn">selenium</button><button class="search_btn">automation
                                    test</button>or <strong style="color: rgba(7, 68, 242, 1);">ask your own
                                    question.</strong></p>
                        </div>
                        <br><br><br>
