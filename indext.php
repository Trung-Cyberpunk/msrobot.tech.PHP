                    ...
                    <div class="main-item_box">
                        ...
                        <div class="item_box">
                            ...
                            <ul>
                                <li class="item_title">
                                    ...
                                    <span> Run our SELENIUM TEST AUTOMATION to know what selenium automation
                                        is.</span><br>
                                    <a id="download" href="#">Download Selenium Test Automation now ></a>
                                </li>
                                <li class="item_title">
                                    <strong>Step 2:</strong> <span> Learn Java Advance.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 3:</strong> <span> Start Selenium Basic.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 4:</strong> <span> Learn Selenium Advance.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 5:</strong> <span> Automate Test cases by yourself (Using our Demo
                                        Sites &
                                        Test cases excel file).</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 6:</strong> <span> Put your automation test cases into github.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 7:</strong> <span> Put your automation test cases into github.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 8:</strong> <span> Apply for QA Analyst, QA Engineer, Software
                                        Developer in
                                        Test job.</span>
                                </li>
                            </ul>
                        ...
                        <div class="item_box">
                            ...
                            <ul>
                                ...
                                <li class="item_title">
                                    <strong>Step 2:</strong> <span> Start Selenium Basic.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 3:</strong> <span> Start Selenium Basic.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 4:</strong> <span> Automate Test cases by yourself (Using our Demo
                                        Sites &
                                        Test cases excel file).</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 5:</strong> <span> Put your automation test cases into github.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 6:</strong> <span> Apply for QA Analyst, QA Engineer, Software
                                        Developer in
                                        Test job.</span>
                                </li>
                        ...
                        <div class="item_box">
                            ...
                            <ul>
                                ...
                                <li class="item_title">
                                    <strong>Step 2:</strong> <span> Understand Selenium Automation Framework.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 3:</strong> <span>Create Framework to run cross Chrome, Firefox, IE,
                                        Safari. </span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 4:</strong> <span> Create Framework to run in multiple platforms
                                        (windows,
                                        mac os, IOS, Android).</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 5:</strong> <span> Create Framework to run in multiple
                                        environments.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 6:</strong> <span> Create Framework to report automation steps.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 7:</strong> <span> Create Framework to run tests in parallel. </span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 8:</strong> <span> Create Framework with page object model.</span>
                                </li>
                                <li class="item_title">
                                    <strong>Step 8:</strong> <span> Create Framework for BDD.</span>
                                </li>
                            </ul>
