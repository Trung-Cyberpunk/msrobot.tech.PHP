    ...
    <body>
        <div class="backgr">
            ...
            ">
                ...
                <!-- <form class="login_ask" action="ecommerce_site.php">
                    ...
                    <div class="box_ask-login">
                        <label for="email_ask" class="ask_after">Email: <strong style="color: rgba(210, 0, 13, 1);"
                                required>*</strong></label>
                        <input type="text" id="email_ask" placeholder="thaole@yahoo.com">
                    </div>
                    <div class="box_ask-login">
                        <label for="pw_ask" class="ask_after">Passwords: <strong style="color: rgba(210, 0, 13, 1);"
                                required>*</strong></label>
                        <input type="text" id="pw_ask" placeholder="Enter">
                    </div>
                    <button class="btn_ask">Login</button>
                </form> -->
                <form class="login_ask" method="post">
                    <h4>To login, provide your sign up email and password.
                        If you are not sign up yet, please
                        <strong id="sign_ask" style="cursor: pointer; color: rgba(255, 100, 0, 1);">
                            click here to signup ></strong>
                    ...
                    <div class="box_ask-login">
                        <label for="email_ask" class="ask_after">Email: <strong style="color: rgba(210, 0, 13, 1);"
                                required>*</strong></label>
                        <input type="email" id="email_ask" placeholder="thaole@yahoo.com" name="email" required>
                    </div>
                    <div class="box_ask-login">
                        <label for="pw_ask" class="ask_after">Passwords: <strong style="color: rgba(210, 0, 13, 1);"
                                required>*</strong></label>
                        <input type="password" id="pw_ask" placeholder="Enter" name="password" required>
                    </div>
                    <button class="btn_ask" name="login_2">Login</button>
